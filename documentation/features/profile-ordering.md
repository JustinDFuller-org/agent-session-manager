...
When you open the New Pane sheet, the profile picker pre-selects the first profile in ranked order whose CLI type matches the active tool. For example, if your profiles in order are:
