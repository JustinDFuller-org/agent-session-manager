...
| Invariants | `statusline.worktree.name_mismatch`, `statusline.lines.source_mismatch`, `app.bundle_identity.preferred_url_mismatch`, `app.launch.auxiliary_window_opened`, `app.launch.auxiliary_windows_checked`, `invariant.log.write_failed` |
