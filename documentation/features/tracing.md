...
| Area | Spans |
|---|---|
| Pane lifecycle | `pane.activated`, `pane.notification.added`, `pane.notification.cleared`, `pane.activity.changed`, `tab.pane.added`, `tab.worktree.resolved` |
...
| Invariants | `statusline.worktree.name_mismatch`, `statusline.lines.source_mismatch`, `invariant.log.write_failed` |
| Notifications | `notification.auth.requested`, `notification.icon.unavailable`, `notification.pane_attention.posted`, `notification.pane_attention.skipped`, `notification.pr_merged.posted` |
