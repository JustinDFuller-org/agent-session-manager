...
| Invariants | `statusline.worktree.name_mismatch`, `statusline.lines.source_mismatch`, `app.bundle_identity.preferred_url_mismatch`, `cursor.agent_control.bridge_missing`, `invariant.log.write_failed` |
