...
To set a custom name, enable the **Session Name** flag in Settings → CLI Options. When `--name` (or `-n`) is present in your CLI options, the auto-injection is skipped and your explicit value is used instead.
