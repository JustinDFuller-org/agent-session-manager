...
Archive only from the base PR after all stack implementation and validation
layers are complete; do not create a competing finalized change in a higher PR.
